...
#stop words list
stop_words = []
with open("stopwords_zh", "r", encoding="utf-8") as f:
    for line in f:
        stop_words.append(line[:-1])

# use chinese stop words instead
...
def get_only_chars(line):
    ...
    # # we need to comment it to include chinese
    # for char in line:
...
# we use synonyms for chinese instead of wordnet
